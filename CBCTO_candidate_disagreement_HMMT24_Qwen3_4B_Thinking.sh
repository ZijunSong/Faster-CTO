#!/bin/bash
# CB-CTO trigger=candidate_disagreement | HMMT24 | Qwen3-4B-Thinking-2507
set -e
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"
export GPU_GROUP="${GPU_GROUP:-GPU0}"
export DATASET=HMMT24
export MODEL_TAG=Qwen3_4B_Thinking
export CB_CTO_TRIGGER=candidate_disagreement
export CB_CTO_THRESHOLD="${CB_CTO_THRESHOLD:-0.35}"
