#!/usr/bin/env python3
"""汇总 B-CTO 多次运行的 Pass@1 mean±std 与效率指标。"""
import argparse
import json
    ...
    for run_id in range(1, num_runs + 1):
        ...
        for fp in sorted(res_dir.glob("*.json")):
            try:
                ...
                continue
            comp = data.get("b_cto_compute") or data.get("cto_compute") or {}
...
def main():
    ...
    parser.add_argument("--b-cto-trigger", required=True)
    ...
    if values:
        ...
        summary = {
            ...
            "b_cto_trigger": args.b_cto_trigger,
            "eval_iter": iter_tag,
