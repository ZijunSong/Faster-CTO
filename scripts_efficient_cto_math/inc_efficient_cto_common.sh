#!/bin/bash
# CTO-Rescore 数学实验公共配置（vLLM-only step3/5/7）
...
export EFFICIENT_CTO_METHOD="${EFFICIENT_CTO_METHOD:-cto_rescore}"
...
export RUNS_ROOT="${RUNS_ROOT:-${PROJECT_ROOT}/runs_${EFFICIENT_CTO_METHOD}_math/${DATASET}/${MODEL_TAG}_${EFFICIENT_CTO_METHOD}_${GPU_GROUP}}"
